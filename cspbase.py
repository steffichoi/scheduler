...
class Variable: 
    ...
    def __init__(self, task, domain=[]):
        ...
        '''
        self.name = task.name           #text name for variable
        self.task = task
    ...
    def add_domain_values(self, values, span, slots):
    ...
    def assign(self, value):
        ...
        # Multi-task constraint, dynamic checking instead of storing tuples.
        for s in value:
            if s.get_capacity(self) <= 0:
                return False
